...
public class Reflection {
    ...
    public static Object open(Reference reference, Object[] initArgs)
        ...
        if (reference.getClazz().getAnnotation(Entity.class)!=null) {
            ...
            Field field = null;
            for (Field f : reference.getClazz().getDeclaredFields()) {
...
//            log.trace("new " + clazz.toString() + "(" + Arrays.toString(initArgs) + ")");
    ...
    public static Method findMethod(Object obj, String method, Object[] args)
    ...
    public static boolean isMethodSynchronized(Object obj, String method, Object[] args)
            throws IllegalAccessException {
