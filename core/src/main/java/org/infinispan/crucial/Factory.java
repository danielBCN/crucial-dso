...
import org.infinispan.crucial.container.AbstractContainer;
import org.infinispan.crucial.container.BaseContainer;
...
import static org.infinispan.crucial.utils.Reflection.getConstructor;
...
public class Factory {
    ...
    // Class fields
    public static final String CRUCIAL_CACHE_NAME = "__crucial";
...
//    @Deprecated
    public synchronized static Factory forCache(BasicCache cache, int maxContainers, boolean force) {
        ...
        if ((singleton == null | force) && cache.getName().equals(CRUCIAL_CACHE_NAME)) {
    ...
    public static Factory get(String server) {
        ...
        return forCache(manager.getCache(CRUCIAL_CACHE_NAME));
    }
